...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Admin Panel - Dream Glove Company') }}</title>
        ...
        <div class="h-screen overflow-hidden bg-gray-100 w-full flex">
            <aside class="w-[17%] bg-white border-r h-full overflow-y-auto pb-3">
                <div class="header px-6 py-4">
                    <button class="rounded-full bg-gray-900 w-10 h-10 mb-5 border-4 text-white flex items-center justify-center">D</button>
                    <h4 class="text-zinc-500 text-sm">Store</h4>
                    <h4 class="text-sm">Dream Gloves Co.</h4>
                </div>
                <ul class="mt-5">
                    <li class="px-3">
                        <x-side-link href="#">
                    ...
                    <li class="px-3">
                        <x-side-link href="{{ route('product.index') }}">
                    ...
                    <hr class="my-2"/>
                    <li class="px-3">
                        <x-side-link href="{{ route('category.index') }}">
