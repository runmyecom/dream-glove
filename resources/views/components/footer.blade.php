<footer class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-10">
        ...
        <a class="flex-none text-xl font-semibold dark:focus:outline-none dark:focus:ring-1 " href="#" aria-label="Brand">
            <img src="/logo-b.png" alt="logo" class="h-9 md:h-12">
        </a>
        <p class="mt-3 text-xs sm:text-sm text-gray-600 ">© 2024 DreamGlove.</p>
        </div>
        <!-- End Col -->
        ...
        <div class="mt-3 grid space-y-3 text-sm">
            ...
            <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800" href="#">Return Policy</a></p>
        ...
        <div>
        <h4 class="text-xs font-semibold text-gray-900 uppercase">Social</h4>

        <div class="mt-3 grid space-y-3 text-sm">
            <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800" href="#">Facebook</a></p>
            <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800" href="#">Twitter</a></p>
    ...
    <div class="pt-5 mt-5 border-t border-gray-200">
        ...
        <div class="flex justify-between items-center">
            ...
            <a class="flex-none text-xl font-semibold" href="#" aria-label="Brand">Dream Gloves</a>
