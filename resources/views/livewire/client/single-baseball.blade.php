                ...
                <div class="grid md:grid-cols-2 gap-12">
                    ...
                    <div class="w-full">
                        ...
                        <section>
                            ...
                            <div class="mt-6">
                                <h2 class="font-bold">Glove Size</h2>
                                <select name="gloveSize" class="mt-3">
                                    ...
                                    <option value="">Youth Extra Large</option>
                                    <option value="">Youth Large</option>
                                    <option value="">Youth Medium</option>
                                    <option value="">Youth Small</option>
                                </select>
                            </div>
                        </section>
