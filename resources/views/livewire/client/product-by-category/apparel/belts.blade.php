<div>
    <section class="max-w-7xl mx-auto py-12">
        <h2 class="font-bold md:text-[3em] text-[2.5em] text-center">Apparel > Belts</h2>
        ...
        <div class="grid md:grid-cols-3 gap-5 mt-12">
            @foreach ($products as $product)
                <div class="card">
                    <a href="{{ route('single-belt', $product->slug) }}" class="image bg-gray-100 rounded-xl overflow-hidden shadow md:h-[45vh] h-[30vh] flex items-center justify-center relative group cursor-pointer">
                        @php
