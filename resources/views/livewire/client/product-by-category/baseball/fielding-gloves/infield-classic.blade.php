<div>
    <section class="max-w-7xl mx-auto py-12">
        <h2 class="font-bold md:text-[2em] text-[2em] text-center">Baseball > Fielding Gloves > Infield > Classic</h2>
        ...
        <div class="grid md:grid-cols-4 gap-5">
            ...
            <div class="card">
                <a href="{{ route('baseball-fielding-gloves-infield-classic.glove-12') }}" class="image bg-white rounded-xl overflow-hidden shadow md:h-[40vh] h-[30vh] flex items-center justify-center relative group cursor-pointer">
                    <img src="/thumb/glove-1.png" alt="" class="group-hover:scale-125 transition duration-700 ease-in-out rounded-lg">
