    ...
    <section class="max-w-7xl mx-auto py-12">
        ...
        <div class="grid md:grid-cols-3 gap-5 mt-12">
            @foreach ($products as $product)
                <div class="card">
                    <a href="{{ route('single-product', $product->slug) }}" class="image bg-gray-100 rounded-xl overflow-hidden shadow md:h-[45vh] h-[30vh] flex items-center justify-center relative group cursor-pointer">
                        @php
