<div>
    ...
    <div class="min-w-screen h-full py-5">
        <div class="px-5 max-w-7xl mx-auto flex items-center justify-between">
            <div>
                <div class="mb-2">
                    <a href="{{ route('shopping-cart') }}" class="focus:outline-none hover:underline text-gray-500 text-sm flex items-center gap-1">
                        <x-icons.arrowleft class="w-4 h-4" />Back
                    </a>
                </div>
                <div class="mb-2">
                ...
                <div class="mb-5 text-gray-400 text-sm">
                    ...
                    /
                    <a href="{{ route('shopping-cart') }}" class="focus:outline-none hover:underline text-gray-500">Shopping Cart</a>
                    /
